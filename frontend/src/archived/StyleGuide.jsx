	...
	return (
		<div className="page-container style-guide">
			...
			<p className='tagline'>Welcome to the Style Guide page. This page defines the visual and voice guidelines for Flowboard.</p>
				...
				<div className='section brand-section' id="brand">
					<h2>Brand</h2>
					<p>
				...
				<Divider />
				<div className='section typography-section' id="typography">
					<h2>Typography</h2>
				...
				<Divider/>
				<div className='section' id="color-palette">
					<h2>Color Palette</h2>
				...
				<Divider />
				<div className='section'id="iconography">
					<h2>Iconography</h2>
